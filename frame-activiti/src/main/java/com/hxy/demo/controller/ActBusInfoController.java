...
public class ActBusInfoController {
    ...
    public String declare(ProcessTaskDto processTaskDto, Model model,String flag){
        DeclareEntity declareEntity = declareService.queryObject(processTaskDto.getBusId());
        model.addAttribute("declare",declareEntity);
        model.addAttribute("taskDto",processTaskDto);
        model.addAttribute("flag",flag);
        return "/demo/declareActInfo.jsp";
    }
}
